...
{    
	...
	if (downloadFilename)
	{
		document = [[NSXMLDocument alloc] initWithContentsOfURL:[NSURL fileURLWithPath:downloadFilename] options:NSXMLNodeLoadExternalEntitiesSameOriginOnly error:&error];
